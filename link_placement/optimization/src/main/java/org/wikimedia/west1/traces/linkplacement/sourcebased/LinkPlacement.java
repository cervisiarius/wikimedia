...
public abstract class LinkPlacement {
	...
	public final static String DATADIR_SIMTK = System.getenv("HOME") + "/wikimedia/trunk/data/simtk/";
	...
	protected abstract double getWeight(String src);
	...
	public void placeLinks(int numLinks, PrintStream out) {
		...
		for (int i = 0; i < numLinks; ++i) {
			...
			double chainValue = getWeight(cand.src) * unnormCumSum
			...
			double coinsValue = getWeight(cand.src) * unnormCumSum;
			...
			double treeValue = getWeight(cand.src) * (1 - probNone);
