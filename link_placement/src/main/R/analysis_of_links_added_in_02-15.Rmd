...
plot(1:nrow(active), active$click_prob_after[order(active$num_external_searches_before)], col='#00000005', pch=16)
lowess <- lowess(1:nrow(active), active$click_prob_after[order(active$num_external_searches_before)])
lines(lowess$x, lowess$y)
