...
---- Used instead: sort_revision_table_and_add_first_flag.pig followed by count_creator_edits_before_creation.py
...
Joined = JOIN Rev BY user_id, First BY user_id PARALLEL $PARALLEL;
