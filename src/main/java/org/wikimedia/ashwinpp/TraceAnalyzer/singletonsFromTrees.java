...
public class singletonsFromTrees extends EvalFunc<DataBag> {
    public DataBag exec(Tuple input) throws IOException {
        ...
        try{
            ...
            return root.generateSingletonsBag();
        }catch(Exception e){
    ...
    public Schema outputSchema(Schema input) {
        try{
            ...
            tupleFs = new Schema.FieldSchema("singleton", tupleSchema, DataType.TUPLE);
            Schema bagSchema = new Schema(tupleFs);
            bagSchema.setTwoLevelAccessRequired(true);
            Schema.FieldSchema bagFs = new Schema.FieldSchema("bag_of_singletons",bagSchema, DataType.BAG);
