...
public class triplesFromTrees extends EvalFunc<DataBag> {
    public DataBag exec(Tuple input) throws IOException {
        ...
        try{
            ...
            return root.generateTriplesBag();
        }catch(Exception e){
    ...
    public Schema outputSchema(Schema input) {
        try{
            ...
            tupleFs = new Schema.FieldSchema("triples", tupleSchema, DataType.TUPLE);
            Schema bagSchema = new Schema(tupleFs);
            bagSchema.setTwoLevelAccessRequired(true);
            Schema.FieldSchema bagFs = new Schema.FieldSchema("bag_of_triples",bagSchema, DataType.BAG);
